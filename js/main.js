...
$('.activate').on('click', function(e){
  e.preventDefault();
  if(accountID){
    document.querySelector(".disconnect-wrapper").classList.add("active");
  }
  else{
...
$('.disconnect-wallet-btn').on('click', function(e){
  e.preventDefault();
...
document.getElementById("slide2").addEventListener('mousedown', function(event){
  isClickInsideElement1 = document.querySelector(".contact-wrapper").contains(event.target);
  isClickInsideElement2 = document.querySelector(".disconnect-wrapper").contains(event.target);
  if(!isClickInsideElement1 || !isClickInsideElement2){
    document.querySelector(".contact-wrapper").classList.remove("active");
    document.querySelector(".disconnect-wrapper").classList.remove("active");
  }
},false);
...
function loginwallet(username, password){
  var email;
